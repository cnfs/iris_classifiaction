...
PreparedStatement pst=null;
    ...
    public searchEmpSalarySlip() {
        initComponents();
        this.setTitle("Payroll System-Generate Slip");
        conn=db.java_db();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Details are inavlid to generate slip","Message",JOptionPane.DEFAULT_OPTION);
            return;
        }
        ...
        try {
            ...
            rs=pst.executeQuery(); 
            String x="",ot="0",med="0",bonus="0",oth="0";
            while(rs.next())
            {
                x=rs.getString("total_allowance");
                ot=rs.getString(2);
                med=rs.getString(3);
           ...
           myDocument.add(new Paragraph("Overtime: Rs"+ot,FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN)));
           myDocument.add(new Paragraph("Medical: Rs" +med,FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN)));
           myDocument.add(new Paragraph("Bonus: Rs"+bonus,FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN)));
           myDocument.add(new Paragraph("Other: Rs"+oth,FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN)));
           myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
           ...
           myDocument.add(new Paragraph("Total Deductions : Rs"+v ,FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN)));
           myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
           myDocument.add(new Paragraph("TOTAL PAYMENT",FontFactory.getFont(FontFactory.TIMES_ROMAN,15,Font.BOLD)));
           myDocument.add(new Paragraph("Total Allowances: Rs"+y,FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN)));
            myDocument.add(new Paragraph("Total Deductions: Rs"+v,FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN)));
